...
// documented voices for the speech API.
const DEFAULT_OPENAI_VOICES: Voice[] = [
  { id: 'alloy', name: 'Alloy', language: 'en-US', gender: 'neutral', provider: 'openAI' },
  { id: 'ash', name: 'Ash', language: 'en-US', gender: 'male', provider: 'openAI' },
  { id: 'coral', name: 'Coral', language: 'en-US', gender: 'female', provider: 'openAI' },
  ...
  { id: 'sage', name: 'Sage', language: 'en-US', gender: 'female', provider: 'openAI' },
...
class OpenAIAdapter implements ProviderAdapter {
  ...
  constructor(context: ProviderContext) {
    ...
    const envKey = allowServerKey ? process.env.OPENAI_API_KEY?.trim() : undefined;
